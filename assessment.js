...
var myFriends = ["David", "Scott", "Curtis", "Michael"];
...
//DON'T TOUCH THE CODE ABOVE
function evensOnly() {
var evens = myNumbers.filter(function(element){return element % 2 == 0;});
  return evens;
}
...
var trueFriends = peopleIknow.filter(function(element){return element.friend == true;});
